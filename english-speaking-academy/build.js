...
<head>
  ...
  <title>Speak Up — English Speaking Academy</title>
  <meta name="description" content="A complete, friendly, step-by-step course that takes you from basic to advanced spoken English — pronunciation, conversation, fluency, IELTS/TOEFL/Cambridge speaking, job interviews and public speaking. With microphone practice and mock exams." />
...
<body>
  ...
  <header class="topbar">
    ...
    <label class="searchbox" title="Search lessons & phrases">
      🔍 <input id="search" type="text" placeholder="Search lessons or phrases…" autocomplete="off" />
    </label>
  </header>
